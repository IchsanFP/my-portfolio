            ...
            <div className="flex justify-center gap-2 px-8 m-auto lg:px-32 md:px-16">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="flex flex-col items-center justify-center gap-1 my-5">
                        <h1 data-aos="fade-up" data-aos-duration='1000' data-aos-delay="200" className="text-xl font-bold text-center font-poppins md:text-2xl text-light-50">Hi, I’m Ichsan Fadhlika Pangestu</h1>
                        <h1 data-aos="fade-up" data-aos-duration='1000' data-aos-delay="300" className="text-base font-semibold text-center font-poppins md:text-lg text-light-200">Frontend Developer</h1>
                    </div>
                    ...
                    >
                        I am interested in Software Engineering, especially in Web Development. Other than that, I am also interested in UI/UX design and mobile development. I love to learn new things and am always open to new opportunities.
                    </p>
                    ...
                    <div className="flex justify-center gap-2">
                        ...
                        >
                            <a target="_blank" href="https://drive.google.com/file/d/1TFyMhmmOLEvVwz6YPEu0cIjK4kxjJtJm/view?usp=sharing">Download CV</a>
                        </button> 
                        <button 
                            type="button" data-aos="fade-up" data-aos-duration='1000' data-aos-delay="500" 
